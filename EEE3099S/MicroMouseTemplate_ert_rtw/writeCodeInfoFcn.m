% Autogenerated file: Tue Sep 17 16:05:35 2024
...
wr = coder.internal.writeDataInterfacesToCodeDescriptor("MicroMouseTemplate",pwd) ;
...
skippedParameters = [];
    ...
    % Matrix Type
    Type_49_R0_V0_C0 = coder.types.Matrix;
    Type_49_R0_V0_C0.BaseType   = Type_0_R0_V0_C0;
        Type_49_R0_V0_C0.Dimensions = [1,1];
    ...
    func_Initialize_Prototype.Return     = tmpRet;
        ...
        func_Initialize_Prototype.HeaderFile = 'MicroMouseTemplate.h';
    func_Initialize_Prototype.SourceFile = 'MicroMouseTemplate.c';
    ...
    func_Initialize_Interface.ActualReturn = tmpActualReturn;
        ...
        func_Initialize_Prototype.Name = 'MicroMouseTemplate_initialize';
    ...
    func_OutputUpdate0_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate0_Prototype.HeaderFile = 'MicroMouseTemplate.h';
    func_OutputUpdate0_Prototype.SourceFile = 'MicroMouseTemplate.c';
    ...
    func_OutputUpdate0_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate0_Prototype.Name = 'MicroMouseTemplate_step0';
    time_1 = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, 1));
        func_OutputUpdate0_Interface.Timing = time_1;
    ...
    func_OutputUpdate2_Prototype.Return     = tmpRet;
        ...
        func_OutputUpdate2_Prototype.HeaderFile = 'MicroMouseTemplate.h';
    func_OutputUpdate2_Prototype.SourceFile = 'MicroMouseTemplate.c';
    ...
    func_OutputUpdate2_Interface.ActualReturn = tmpActualReturn;
            ...
            func_OutputUpdate2_Prototype.Name = 'MicroMouseTemplate_step2';
    ...
    func_Terminate_Prototype.Return     = tmpRet;
        ...
        func_Terminate_Prototype.HeaderFile = 'MicroMouseTemplate.h';
    func_Terminate_Prototype.SourceFile = 'MicroMouseTemplate.c';
    ...
    time_constant = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, -1));
        func_Terminate_Interface.Timing = time_constant;
                func_Terminate_Prototype.Name = ['MicroMouseTemplate_terminate'];
        codeInfo.TerminateFunctions =  [codeInfo.TerminateFunctions, func_Terminate_Interface'];
            ...
            type_RTModel.Identifier = 'RT_MODEL_MicroMouseTemplate_T';
        ...
        Var_RTModel = RTW.Variable(Ptrtype_RTModel_1_0.BaseType, 'MicroMouseTemplate_M_');
        Var_RTModel.Owner           = 'MicroMouseTemplate';
        Var_RTModel.DeclarationFile = 'MicroMouseTemplate.h';
            Var_RTModel.DefinitionFile  = 'MicroMouseTemplate.c';
        

        % Pointer Variable: PtrVar_RTModel
        PtrVar_RTModel = RTW.PointerVariable(Ptrtype_RTModel_1_0, 'MicroMouseTemplate_M', Var_RTModel);
